...
public class GridAdapter extends BaseAdapter
{
	 ...
	 */
	public GridAdapter(FragmentActivity activity, Context context, boolean info)
	{
	...
	{		
		...
		if(v == null)
		{
			...
			v.setTag(R.id.griditem_image_loading, v.findViewById(R.id.griditem_image_loading));
	    ...
	    final ProgressBar loadingBar = (ProgressBar)v.getTag(R.id.griditem_image_loading);
	    ...
	    ElementImageManager.getImage(element, new OnImageDownload() {
			...
			public void onFinish(Element element) {
				...
				new AlphaToggle(null, imatge, 1000).execute();
				new AlphaToggle(null, loadingBar, 500).setToggled().execute();
			}
		});
