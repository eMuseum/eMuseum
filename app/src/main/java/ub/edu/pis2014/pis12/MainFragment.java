...
import ub.edu.pis2014.pis12.controlador.GridAdapter.TIPUS_ORDENACIO;
...
public class MainFragment extends Fragment {
	...
	private static GridAdapter adapter = null;
	...
	public void onViewCreated(View view, Bundle savedInstanceState)
	{
		...
		if (adapter == null)
		{
			adapter = new GridAdapter(getActivity(), context, true);
