...
public class ElementImageManager {
     ...
     * esta en la llista)
     *
     * @param element         Element del que volem descarregar
     * @param onImageDownload Callback a executar al acabar
     */
     ...
     * o null
     *
     * @param element Element del que busquem bitmap
     ...
     *
     * @param activity Activity en que estem
     */
